...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
GET a 3rd STOCK ---> EMERGING MARKET: # # # # # # # # # # # # 
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
...
#Price Stock 1:
df = pd.read_csv('/Users/filipepessoajorge/OneDrive/X002 - Python_Developing/GitHub/Economic_data/Economic_data/AAA_Tese/Data_/df_EWMA_3_assets.csv')
...
for ticker in list_tickers:
    name = 'df_'+ticker
    df_list.append(name)
    name = pd.DataFrame(df[ticker], columns=[ticker]) 
...
GET a FUNCTIONING FUNCTION BY JANUARY
