...
'''
print('Entry_GALP:\n%f \nEntry_Repsol:\n%f' % (entry_galp, entry_repsol))
print('Ratio: ', round(entry_galp/entry_repsol,4))
'''
...
scenarios = [
    [10.4, 7.6], # Best
    [9.3, 8.9], # Worst
    [ round(df[tickers[0]].iloc[-1],3), round(df[tickers[1]].iloc[-1],3)] #Last
]
...
print('Ratio Entry:\t%.3f \nRatio Exit:\t%.3f' % (p1/p2, p1_out/p2_out) )
print('\nThe End\n')