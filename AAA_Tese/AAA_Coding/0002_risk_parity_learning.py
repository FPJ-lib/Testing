#https://www.fromthegenesis.com/risk-parity-a-portfolio-management-strategy-python/
...
def _risk_budget_objective_error(weights, args):
    ...
    # We calculate the risk of the weights distribution
    portfolio_risk = _allocation_risk(weights, covariances)
    #print('\nPortfolio Risk ( weights, Covariances):\n', portfolio_risk)
...
def get_weights(yahoo_tickers=['^GSPC','GOVT', 'EEM','GLD'],
                start_date=datetime.datetime(2011, 10, 31),
    ...
    print('ASSET RISK - budget\n', assets_risk_budget)

    # Initial weights: equally weighted
    init_weights = [1 / prices.shape[1]] * prices.shape[1] # Build a matrix
